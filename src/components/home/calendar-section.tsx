...
export function CalendarSection() {
  ...
  return (
    ...
    <section id="calendar" className="py-24 md:py-40 bg-[#FBFBFE] relative overflow-hidden">
      ...
      {/* Abstract Yellow Line Art / Geometric Design */}
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
        ...
        <div className="mb-20 md:mb-24 max-w-4xl md:text-center mx-auto">
          <h2 className="text-4xl md:text-7xl font-black text-[#0F172A] tracking-tighter leading-[1.1] mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8 items-start">
          ...
          {/* Left: Premium Light Calendar Grid */}
          ...
          {/* Right: Dual Bento Registry */}
          <div className="flex flex-col gap-6 h-full">

            {/* Top Card: Selected Day Details */}
            ...
            {/* Bottom Card: Animated Upcoming Feed */}
